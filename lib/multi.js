...
class MultiFsLog {
  ...
  // todo: lock
  // todo: test that data not too big
  ...
  async appendBatch(data, seq=null) {
    ...
    await this._nextLog(data)
      .then((log) => log.appendBatch(data, rel))
