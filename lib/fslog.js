...
class FsLog {
  ...
  async _handleLock() {
    ...
    try {
      ...
      handles.push(fhlock)
      const offset = await this._readOffset(fhlock)
      ...
      // rollback
      works = []
      works.push(truncate(fhlog, 123))
      works.push(this._writeOffset(fhoff, 123))
  ...
  async append(data, seq=null) {
    ...
    await this._writeOffset(this.fhlock, offset)
